...
public class Vegetables implements Images {
    ...
    public ArrayList<CaptchaImage> getImages() {
        ...
        File dir = new File("src"+File.separator+"fr"+File.separator+"upem"+File.separator+"captcha"+File.separator+"images"+File.separator+"food"+File.separator+"vegetables");
    ...
    public ArrayList<CaptchaImage> getImages(int number) {
        ...
        CaptchaFilesManager.getAllFilesWithExtension(new File("src"+File.separator+"fr"+File.separator+"upem"+File.separator+"captcha"+File.separator+"images"+File.separator+"food"+File.separator+"cake"), "png", allImages);
