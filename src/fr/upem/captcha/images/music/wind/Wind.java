...
public class Wind implements Images {
    ...
    public ArrayList<CaptchaImage> getImages() {
        ...
        File dir = new File("src"+File.separator+"fr"+File.separator+"upem"+File.separator+"captcha"+File.separator+"images"+File.separator+"music"+File.separator+"wind");
